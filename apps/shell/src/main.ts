...
async function bootstrap() {
  ...
  const builtinApps: AppManifest[] = [
    ...
    {
      id: 'com.ditto.terminal',
      name: '终端',
      version: '0.1.0',
      description: 'Ditto 终端模拟器，支持 VFS 文件操作',
      icon: 'fa-solid fa-terminal',
      entry: 'terminal/index.html',
      category: 'system',
      sandbox: 'trusted',
      permissions: [],
      window: { width: 720, height: 480, minWidth: 400, minHeight: 240, resizable: true, maximizable: true },
    },
    {
      id: 'com.ditto.editor',
      name: '文本编辑器',
      version: '0.1.0',
      description: 'Ditto 文本编辑器，支持 VFS 读写',
    ...
    {
      id: 'com.ditto.monitor',
      name: '系统监视器',
      version: '0.1.0',
      description: 'Ditto 系统监视器，查看内核/应用/窗口状态',
      icon: 'fa-solid fa-gauge-high',
      entry: 'monitor/index.html',
      category: 'system',
      sandbox: 'trusted',
      permissions: [],
      window: { width: 640, height: 600, minWidth: 400, minHeight: 360, resizable: true, maximizable: true },
    },
    {
      id: 'com.ditto.chat',
      name: '聊天室',
      version: '0.1.0',
      description: 'Ditto 实时聊天室，多用户 WebSocket 通信',
      icon: 'fa-solid fa-comments',
      entry: 'chat/index.html',
      category: 'social',
      sandbox: 'trusted',
      permissions: [],
      window: { width: 480, height: 600, minWidth: 320, minHeight: 400, resizable: true, maximizable: true },
    },
    {
      id: 'com.ditto.resources',
      name: '资源仓库',
      version: '0.1.0',
      description: 'Ditto 资源仓库，集中管理文档/代码/主题/教育资源',
      icon: 'fa-solid fa-box-archive',
      entry: 'resources/index.html',
      category: 'system',
      sandbox: 'trusted',
      permissions: [],
      window: { width: 800, height: 600, minWidth: 480, minHeight: 360, resizable: true, maximizable: true },
    },
  ];
